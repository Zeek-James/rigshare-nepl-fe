  ...
  const MetricCard = ({ title, count, trend, trendType, icon }) => (
    <div className='bg-white rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition-shadow'>
      ...
      <div className='flex items-end justify-between'>
        ...
        >
          <span className='text-xs'>{trendType === "up" ? "↗️" : "↘️"}</span>
          <span>{trend}</span>
        </div>
      </div>
    </div>
      ...
      <div className='space-y-4'>
        ...
        <div className='space-y-2 text-sm text-gray-600'>
          ...
          <div className='flex justify-between'>
            <span>Status:</span>
            <span
              className={`px-2 py-1 rounded-full text-xs font-medium ${program.statusColor}`}
            >
              {program.status}
            </span>
          </div>
      ...
      <div className='flex gap-4'>
        ...
        <div className='flex-1'>
          ...
          <p className='text-sm text-gray-600 mb-2'>
            Available from {equipment.availableFrom}
          </p>
          ...
          <div className='bg-gray-50 rounded-2xl p-6'>
            <div className='mb-6'>
              ...
              <p className='text-gray-600 text-sm'>
                Based on your latest well program, here are suitable equipment
                options:
              </p>
            </div>
            <div className='space-y-4'>
