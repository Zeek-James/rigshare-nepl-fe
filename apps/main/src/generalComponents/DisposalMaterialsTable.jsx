    ...
    return [
        ...
        <div className="w-full flex flex-col gap-4 relative max-w-[200px]">
          ...
          {expandedIndex === index && (
            <div className="flex items-center gap-8 max-w-max w-full justify-between">
              <TitleAndSubtitle title={"Ownership"} subtitle={el?.component} />
            </div>
          )}
        </div>
      </div>,
      <div className="w-full flex flex-col gap-4">
        <div className="flex items-center gap-3 max-w-max w-full">
          <TitleAndSubtitle title={"Operator"} subtitle={el?.quantity} />
          <TitleAndSubtitle title={"NUIMS"} subtitle={el?.quantity} />
        </div>        {expandedIndex === index && (
          <TitleAndSubtitle
                title={"Batch Number"}
      ...
      <div className="w-full flex flex-col gap-4">
        <div className="flex items-center gap-3 max-w-max w-full">
          <TitleAndSubtitle title={"Disposal"} subtitle={<StatusButton status={"Declared"} />} />
          <TitleAndSubtitle title={"Request"} subtitle={<StatusButton status={"Pending"} />} />
        </div>
        {expandedIndex === index && (
          <div className="flex items-center gap-8 max-w-max w-full justify-between">
            <TitleAndSubtitle
      ...
      <div className="w-full flex flex-col gap-4">
        <div className="flex items-center gap-6 max-w-max w-full">
          <TitleAndSubtitle
            title={"Date of Purchase"}
            subtitle={el?.purchaseDate}
          />
          <TitleAndSubtitle
            title={"Location"}
        ...
        {expandedIndex === index && (
          <div className="flex items-center gap-3 max-w-max w-full">
            <TitleAndSubtitle title={"Book Value"} subtitle={el?.material} />
            <TitleAndSubtitle title={"Decalaration Type"} subtitle={el?.capacity} />
          </div>
        )}
      </div>,
    ];
...
export default DisposalMaterialsTable;
