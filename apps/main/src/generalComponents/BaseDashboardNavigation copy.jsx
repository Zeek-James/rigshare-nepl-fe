...
import { antanLogo, nnpcIcon } from "../assets/images";
import { logoutIcon, rigShare_2, searchIcon } from "../assets/icons";
...
import { hasPermissions, clearPermissionCache } from "@rigshare/shared-auth";
  ...
  return (
    <div className='flex h-[100vh] w-full text-blackColor p-0 overflow-hidden'>
      <div
        ...
        } transition-all duration-300 bg-[#006600] z-50 h-full overflow-y-auto scrollbar-hide flex-col items-start justify-between rounded-r-[10px] p-6 border-r ${
