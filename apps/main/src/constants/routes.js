import AdminDashboardPage from "../modules/dashboard/view/AdminDashboardPage";
...
export const publicRoutes = [
  // Debug-only route for manually exercising the Centrifugo connection;
...
export const protectedRoutes = [
  ...
  {
    path: "/dashboard",
    // The two apps previously had their own routes.js with this element
    // hardcoded to AdminDashboardPage (admin) or DashboardPage (operators).
    element:
